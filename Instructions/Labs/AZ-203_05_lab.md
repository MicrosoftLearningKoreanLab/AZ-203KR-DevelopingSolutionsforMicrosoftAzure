...
1.  Access the **Application settings** section of the **App Service** blade.
...
1.  Add the **1.1.1** version of the **Microsoft.ApplicationInsights.AspNetCore** package from NuGet to the current project:
...
1.  Add the **1.1.29** version of the **Microsoft.Net.Http** package from NuGet to the current project:

    ```
    dotnet add package Microsoft.Net.Http --version 1.1.29	
    ```

1.  Add the **1.0.2** version of the **Polly** package from NuGet to the current project:
