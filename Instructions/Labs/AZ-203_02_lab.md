...
1.  In the **Settings** section on the left side of the blade, navigate to the **Application Settings** section.
...
1.  In the **Settings** section on the left side of the blade, navigate to the **Application Settings** settings.
