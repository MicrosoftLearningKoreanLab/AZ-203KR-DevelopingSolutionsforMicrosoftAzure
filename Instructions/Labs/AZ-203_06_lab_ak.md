...
5.  Within the command prompt, enter the following command and press Enter to check out the lab files necessary to complete the **AZ-203.06** lab:
...
5.  In the **Azure Search** blade, select **Create**.
...
9.  In the **Resource groups** blade, select the **MultiTierService** resource group that you created earlier in this lab.

10. In the **MultiTierService** blade, select the **prodsearch\*** Search service that you created earlier in this lab.

11. In the **Search Service** blade, in the **Settings** section, select the **Keys** link.

12. In the **Keys** section, select any one of the keys and record the value. You will use this value later in the lab.
...
6.  Within the **Add index** blade, a list of fields is displayed. Perform the following actions to configure the **id** field:
    ...
    5.  In the **Field Name** field, observe the hard-coded value of **id**.
    
    6.  In the **Type** list, observe the hard-coded option of **Edm.String**.
    
    7.  In the **Retrievable** option, observe that it is hard-coded to **true**.
    
    8.  Leave **Filterable** unselected.
    
    9.  Select **Sortable**.
    
    10. Leave **Facetable** unselected.
    
    11. Leave **Searchable** unselected.

7.  Within the **Add index** blade, perform the following actions to configure the new **name** field:
    
    12. In the **Field Name** field, enter **name**.
    
    13. In the **Type** list, select **Edm.String**.
    
    14. Select **Retrievable**.
    
    15. Leave **Filterable** unselected.
    
    16. Select **Sortable**.
    
    17. Leave **Facetable** unselected.
    
    18. Select **Searchable**.
    
    19. In the **Analyzer** list, select **Standard - Lucene**.

8.  Within the **Add index** blade, perform the following actions to configure the new **price** field:
    
    20. In the **Field Name** field, enter **price**.
    
    21. In the **Type** list, select **Edm.Double**.
    
    22. Select **Retrievable**.
    
    23. Select **Filterable**.
...
9.  Within the **Add index** blade, perform the following actions to configure the new **quantity** field:
    ...
    26. In the **Field Name** field, enter **quantity**.
    
    27. In the **Type** list, select **Edm.Int32**.
    
    28. Select **Retrievable**.
    
    29. Select **Filterable**.
...
10. Within the **Add index** blade, perform the following actions to configure the new **manufacturer** field:
    ...
    32. In the **Field Name** field, enter **manufacturer**.
    
    33. In the **Type** list, select **Edm.String**.
    
    34. Select **Retrievable**.
    
    35. Select **Filterable**.
    
    36. Select **Sortable**.
    
    37. Select **Facetable**.
    
    38. Leave **Searchable** unselected.
...
10. In the **Azure Storage Explorer** application that appears, locate and expand the **prodstorage\* S**torage account that you created earlier in this lab.
...
14. In the **File Explorer** dialog box that opens, perform the following actions:
    ...
    3.  Go to **Allfiles (F):\\Labfiles\\06\\Starter**.
    
    4.  Select the **products.csv** file.
...
7.  In the **Add cognitive search** tab, select **Next: Customize target index**.

8.  In the **Customize target index** tab, perform the following actions:
    
    8.  In the **Index name** field, enter **products**.
    
    9.  In the **Key** list, select **RowKey**.
...
10. In the **Customize target index** tab, perform the following actions to configure the **Key** field:
    ...
    39. In the **Field Name** field, observe the hard-coded value of **Key**.
    
    40. In the **Type** list, observe the hard-coded option of **Edm.String**.
    
    41. Select **Retrievable**.
    
    42. Leave **Filterable** unselected.
    
    43. Select **Sortable**.
    
    44. Leave **Facetable** unselected.
    
    45. Leave **Searchable** unselected.

11. In the **Customize target index** tab, perform the following actions to configure the **name** field:
    
    10. In the **Field Name** field, observe the hard-coded value of **name**.
    
    11. In the **Type** list, observe the hard-coded option of **Edm.String**.
    
    12. Select **Retrievable**.
    
    13. Leave **Filterable** unselected.
    
    14. Select **Sortable**.
    
    15. Leave **Facetable** unselected.
    
    16. Select **Searchable**.
    
    17. In the **Analyzer** list, select **Standard - Lucene**.

12. In the **Customize target index** tab, perform the following actions to configure the **price** field:
    
    18. In the **Field Name** field, observe the hard-coded value of **price**.
    
    19. In the **Type** list, observe the hard-coded option of **Edm.Double**.
    
    20. Select **Retrievable**.
    
    21. Select **Filterable**.
...
13. In the **Customize target index** tab, perform the following actions to configure the **quantity** field:
    ...
    24. In the **Field Name** field, observe the hard-coded value of **quantity**.
    
    25. In the **Type** list, observe the hard-coded option of **Edm.Int32**.
    
    26. Select **Retrievable**.
    
    27. Select **Filterable**.
...
15. In the **Create an indexer** tab, perform the following actions:
    ...
    30. In the **Name** field, enter **tableindexer**.
    
    31. In the **Schedule** section, select **Custom**.
    
    32. In the **Interval** field, enter **5**.
    
    33. Leave the **Start time** field set to its default value.
    
    34. Leave the **Track deletions** field set to its default value.
    
    35. Leave the **Description** field blank.
...
18. In the **Indexer** blade, perform the following actions:
    ...
    38. When prompted for confirmation, select **Yes**.
    
    39. Close the **Indexer** blade.
...
20. Back in the **Search Service** blade, select the **Indexers** tab.

21. In the **Indexers** tab, observe the metadata of the **tableindexer** indexer, such as the document count and the status of the last indexing operation.

22. Close the **Indexer** blade.
...
6.  In the **API Management Service** blade, perform the following actions:
    ...
    7.  In the **Pricing tier** list, select **Developer (No SLA)**.
...
5.  In the **API URL suffix** field, enter **search**.

6.  In the **Products** field, select both **Starter** and **Unlimited**.

7.  Select **Create.**

<!-- end list -->

7.  Wait for the new API to finish being created.

8.  In the **Design** tab, select **+ Add operation**.

9.  In the **Add operation** section, perform the following actions:
    
    8.  In the **Display name** field, enter **List All Documents**.
    
    9.  In the **Name** field, enter **list-all-documents**.
    
    10. In the **URL** list, select **GET**.
    
    11. In the **URL** field, enter **/**.
    
    12. Select **Save**.

10. Back in the **Design** tab, in the list of operations, select **All Operations**.

11. In the **Design** section for **All Operations**, locate the **Inbound processing** tile and select **+ Add policy**.

12. In the **Add inbound policy** section, select the **Set headers** tile.

13. In the **Inbound processing, Set Headers** section, perform the following actions:
    
    13. In the **Name** field, enter **api-key**.
    
    14. In the **Value** field, select the list, select **+ Add Value**, and then enter the value for the **Search Service Key** that you recorded earlier in this lab.
    
    15. In the **Action** list, select the **override** option.
    
    16. Select **Save**.

14. Back in the **Design** tab, in the list of operations, select **All Operations**.

15. In the **Design** section for **All Operations**, locate the **Inbound processing** tile and select **+ Add policy**.

16. In the **Add inbound policy** section, select the **Set query parameters** tile.

17. In the **Inbound processing, Set Query Parameters** section, perform the following actions:
    
    17. In the **Name** field, enter **api-version**.
    
    18. In the **Value** field, enter **2017-11-11**.
    
    19. In the **Action** list, select **override**.
    
    20. Select **Save**.

18. Back in the **Design** tab, in the list of operations, select **List All Documents**.

19. In the **Design** section for the **List All Documents** operation, locate the **Inbound processing** tile and select the **+ Add policy** button.

20. In the **Add inbound policy** section, select the **Set query parameters** tile.

21. In the **Inbound processing, Set Query Parameters** section, perform the following actions:
    
    21. In the **Name** field, enter **search**.
    
    22. In the **Value** field, enter **\***.
    
    23. In the **Action** list, select **override**.
    
    24. Select **Save**.

22. Back in the **Design** tab, in the list of operations, select **List All Documents**.

23. Select the **Test** tab.

24. Select the **List All Documents** operation.

25. In the **List All Documents** section, select **Send**.

26. Observe the results of the API request.
...
27. Select the **Design** tab to return to the list of operations.
...
5.  In the policy code editor, select **Save**.

6.  Back in the **Design** tab, in the list of operations, select **List All Documents**.

7.  In the **Design** section for the **List All Documents** operation, locate the **Outbound processing** tile and select **+ Add policy**.

8.  In the **Add outbound policy** section, select the **Set headers** tile.

9.  In the **Outbound processing, Set Headers** section, perform the following actions:
...
10. Back in the **Design** tab, in the list of operations, select **List All Documents**.

11. Select the **Test** tab.

12. Select the **List All Documents** operation.

13. In the **List All Documents** section, select **Send**.

14. Observe the results of the API request.
...
6.  Observe the schema in the **Request Body JSON Schema** field. This schema is built by Azure automatically based on the JSON content that you entered in the previous step.
...
8.  In the **Table** list, select **products**.

9.  On the right side of the **Partition Key** field, in the **Dynamic content** pane, within the **When a HTTP request is received** category, select **manufacturer**.

10. On the right side of the **Row Key** field, in the **Dynamic content** pane, within the **When a HTTP request is received** category, select **id**.

11. On the right side of the **Entity** field, in the **Dynamic content** pane, within the **When a HTTP request is received** category, select **Body**.
...
2.  In the **Designer** area, perform the following actions to add a **Response Action**:
    ...
    4.  On the right side of the **Body** field, in the **Dynamic content** pane, within the **Insert of Replace Entity** category, select **Body**.
...
10. In the **Indexer** blade, perform the following actions:
    ...
    41. When prompted for confirmation, select **Yes**.
    
    42. Close the **Indexer** blade.
